...
`numpy=1.26.4`, `pandas=2.2.2`, `pytables=3.9.2`,`tqdm=4.66.4`, `scipy=1.14.0`, `joblib=1.4.2`, `pytorch=2.4.0`, `gpytorch=1.11`, `opencv=4.10.0`, `imageio=2.34.2`, `matplotlib=3.9.1`
